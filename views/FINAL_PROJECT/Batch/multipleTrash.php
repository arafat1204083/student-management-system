...
<div class="header">
    <div class="row">
        <!-- Title -->
        <div class="col-xs-6">
            <h2 style="margin:10px 8px;">Multiple Trash </h2></div>
 ...
 <button type="submit" class="btn btn-danger">Trash Selected</button>';
                   ...
                   <tr class="'.$class.'">
                       ...
                       <div class="btn-group">
                         ...
                         <a href="index.php?id='.$data->batch_id.'"><button type="button" class="btn btn-danger"> Delete</button></a>
