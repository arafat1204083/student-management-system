...
<div class="header">
    <div class="row">
        <!-- Title -->
        <div class="col-xs-6">
            <h2 style="margin:10px 8px;">Closed Batch</h2></div>
        <!--profile-->
        <div class="col-xs-11">
            ...
            <div class="row">
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-heading">
                            <h1 style="text-align: center"> Batch Trashed List</h1>
                ...
                <a href="multipleDelete.php"><button class="btn btn-danger">Multiple Delete</button></a>
                        ...
                        <form action="recover.php" method="post" class="form-group">
                            <button type="submit" class="btn btn-success">Active Selected</button>';
                            ...
                            <tr class="'.$class.'">
                             ...
                             <a href="recover.php?id='.$data->batch_id.'"><button type="button" class="btn btn-success">Recover</button></a>
                              <a href="delete.php?id='.$data->batch_id.'"><button type="button" class="btn btn-danger">Single Delete</button></a>
