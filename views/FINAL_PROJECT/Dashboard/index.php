...
$obj= new App\Dashboard\Dashboad();
    ...
    $all_data= $obj->index("obj");

$all_std = count($all_data);
            ...
            <div class="col-xs-12">
                    ...
                    <div class="col-xs-10">
                        ...
                        foreach($allBatch as $batch){
                           ...
                           <a href="student.php?batch=<?php echo $batch->batch_id;?>"><button class="btn btn-success" ><?php echo $batch->batch_name;?></button></a>

                            <?php
                        }
                        ?>
                            <a href="pdf_full.php?batch=0" class="btn btn-info" role="button">Download as PDF</a>
                            <h3>All Students</h3>
                    </div>
